 ...
 */
class ApplicationProductHistory extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_application_product_history';
    }
    ...
    // History Tables
    public function getProductstandardhistory()
    {
        return $this->hasMany(ApplicationProductStandardHistory::className(), ['application_product_history_id' => 'id']);
    }
    public function getProductmaterialhistory()
    {
        return $this->hasMany(ApplicationProductMaterialHistory::className(), ['app_product_history_id' => 'id']);
    }
