 ...
 */
class ApplicationProductMaterialHistory extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_application_product_material_history';
    }
    ...
    {
        return [
            [['app_product_history_id', 'material_id', 'material_type_id'], 'integer'],
            [['percentage'], 'number'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'app_product_history_id' => 'App Product ID',
