 ...
 */
class ApplicationProductStandardHistory extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_application_product_standard_history';
    }
    ...
    {
        return [
            [['application_product_history_id', 'standard_id', 'label_grade_id'], 'required'],
            [['application_product_history_id', 'standard_id', 'label_grade_id'], 'integer'],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'application_product_history_id' => 'Application Product ID',
...
*/
    public function getAppproducthistory()
    {
        return $this->hasOne(ApplicationProductHistory::className(), ['id' => 'application_product_history_id']);
    }
    public function getProductmaterialhistory()
    {
        return $this->hasMany(ApplicationProductMaterialHistory::className(), ['app_product_history_id' => 'application_product_history_id']);
    }
}
