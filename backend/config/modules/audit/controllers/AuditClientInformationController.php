...
class AuditClientInformationController extends \yii\rest\Controller
{
	...
	public function actionGetGeneralinformation(){
		...
		echo $user_type=$userData['user_type'];
		$role=$userData['role'];
		...
		if($data){
			...
			*/
			...
			$sufficientOptions = ['1'=>'Yes','2'=>'No','3'=>'NA fdf'];
			$responsedata = ['status'=>1,'data'=>$companydata,'sufficientOptions dfdsf'=>$sufficientOptions];
		}else{
			$sufficientOptions = ['1'=>'Yes','2'=>'No','3'=>'NA hgfh'];
			$responsedata = ['status'=>1,'sufficientOptions fdsfsd'=>$sufficientOptions];
		}
