...
class AuditExecutionReviewController extends \yii\rest\Controller
{
	...
	public function actionGetQuestions()
    {
		...
		if($post)
		{
			...
			INNER JOIN `tbl_application_unit_process` AS uprs ON unit.id=uprs.unit_id AND unit.id=".$post['unit_id']."
			...
			*/
			...
			if($unit_id !=''){
				$condition .= " AND planunit_exe_checklist.unit_id =".$unit_id." AND planunit.unit_id=".$unit_id."";
			}
			...
			$executionChecklistQuery = "SELECT  planunit.unit_id,reviewer_comment.finding_type as findingType,reviewer_comment.comment as reviewercomment,reviewer_comment.answer as revieweranswer,
