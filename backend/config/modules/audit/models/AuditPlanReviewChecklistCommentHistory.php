...
/**
 * This is the model class for table "tbl_audit_plan_review_checklist_comment_history".
 *
 * @property int $id
 ...
 */
class AuditPlanReviewChecklistCommentHistory extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_audit_plan_review_checklist_comment_history';
    }
    ...
    {
        return [
            [['audit_plan_review_history_id', 'question_id'], 'integer'],
