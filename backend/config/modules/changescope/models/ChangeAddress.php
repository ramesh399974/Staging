...
/**
 * This is the model class for table "tbl_cs_change_address".
 *
 * @property int $id
 * @property int $app_id
 * @property int $status
 ...
 */
class ChangeAddress extends \yii\db\ActiveRecord
{
	public $arrStatus=array('0'=>'Draft','1'=>'Submitted');
	public $arrEnumStatus=array('draft'=>'0','submitted'=>'1');
	...
	public function getChangeaddressunit()
    {
        return $this->hasOne(ChangeAddressUnit::className(), ['change_address_id' => 'id']);
    }
