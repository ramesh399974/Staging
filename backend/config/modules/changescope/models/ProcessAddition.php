...
/**
 * This is the model class for table "tbl_cs_process_addition".
 *
 * @property int $id
 * @property int $app_id
 * @property int $status
 ...
 */
class ProcessAddition extends \yii\db\ActiveRecord
{
	//public $arrStatus=array('0'=>'Open','1'=>'Submitted');
	//public $arrEnumStatus=array('open'=>'0','submitted'=>'1');
    ...
    {
        return 'tbl_cs_process_addition';
    }
    ...
    {
        return $this->hasMany(ProcessAdditionUnit::className(), ['process_addition_id' => 'id']);
    }
