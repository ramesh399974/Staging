			...
			*/
			...
			if ($model !== null)
			{
				...
				*/
				...
				$resultarr['consultant_name']= $model->consultant_name?$model->consultant_name:'None';
				$resultarr['consultancy_company']=$model->consultancy_company?$model->consultancy_company:'None';
