		...
		if ($data) 
		{
			...
			*/
			...
			if ($modelModel !== null)
			{
				...
				$resultarr['audit_type_name']=$auditmodel->audittypeArr[$modelModel->audit_type];
				$resultarr['type_label']=$modelModel->application?$applicationmod->arrAuditType[$modelModel->application->audit_type]:'NA';
