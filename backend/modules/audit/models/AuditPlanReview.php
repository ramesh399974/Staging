...
/**
 * This is the model class for table "tbl_audit_plan_review".
 *
 * @property int $id
 ...
 */
class AuditPlanReview extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['audit_plan_id', 'user_id', 'review_result', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'integer'],
            [['comment'], 'string'],
    ...
    public function getAuditplanreviewchecklistcomment()
    {
        return $this->hasMany(AuditPlanReviewChecklistComment::className(), ['audit_plan_review_id' => 'id']);
    }
    public function getAuditplanunitreviewcomment()
    {
        return $this->hasMany(AuditPlanUnitReviewChecklistComment::className(), ['audit_plan_review_id' => 'id']);
    }
