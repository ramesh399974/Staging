 ...
 */
class AuditPlanUnitExecutionFollowup extends \yii\db\ActiveRecord
{
    //public $arrStatus = [0=>'Open',1=>'Waiting for Unit Lead Auditor Approval',2=>'Approved',3=>'Correction needed',4=>'Waiting for Lead Auditor Approval'];
    //public $arrEnumStatus = ['open'=>0,'waiting_for_unit_lead_auditor_approval'=>1,'completed'=>2,'reintiate'=>3,'waiting_for_lead_auditor_approval'=>4];

    public $arrStatus = [0=>'Open',1=>'Waiting for Unit Lead Auditor Approval',2=>'Approved',3=>'Correction needed', 4=>'In-Progress' ];
    public $arrEnumStatus = ['open'=>0,'waiting_for_unit_lead_auditor_approval'=>1,'completed'=>2,'reintiate'=>3, 'inprogress'=> 4];
    //,4=>'Waiting for Lead Auditor Approval'
    //,'followup_open'=>4,'followup_inprogress'=>5,'followup_waiting_for_unit_lead_auditor_approval'=>6,'followup_lead_auditor_'=>6,'followup_waiting_for_lead_auditor_approval'=>6,'followup_waiting_for_lead_auditor_approval'=>'5'
    /**
     * {@inheritdoc}
     */
    public static function tableName()
    {
        return 'tbl_audit_plan_unit_execution_followup';
    }
