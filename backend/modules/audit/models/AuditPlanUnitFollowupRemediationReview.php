...
/**
 * This is the model class for table "tbl_audit_plan_unit_followup_remediation_review".
 *
 * @property int $id
 ...
 */
class AuditPlanUnitFollowupRemediationReview extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_audit_plan_unit_followup_remediation_review';
    }
