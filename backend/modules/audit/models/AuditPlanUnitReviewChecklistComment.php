...
/**
 * This is the model class for table "tbl_audit_plan_unit_review_checklist_comment".
 *
 * @property int $id
 ...
 */
class AuditPlanUnitReviewChecklistComment extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_audit_plan_unit_review_checklist_comment';
    }
    ...
    {
        return [
            [['audit_plan_review_id', 'unit_id', 'question_id'], 'integer'],
