...
/**
 * This is the model class for table "tbl_cs_standard_addition".
 *
 * @property int $id
 * @property int $app_id
 ...
 */
class StandardAddition extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_cs_standard_addition';
    }
	...
	public function getAppstandard()
    {
        return $this->hasMany(StandardAdditionStandard::className(), ['standard_addition_id' => 'id']);
    }
