...
/**
 * This is the model class for table "tbl_cs_withdraw".
 *
 * @property int $id
 * @property int $app_id
...
{
	public $arrStatus=array('0'=>'Open','1'=>'Pending with Customer','2'=>'Waiting for OSS Review','3'=>'Pending with OSS','4'=>"Waiting for Review",'5'=>'Review in Process','6'=>'Approved','7'=>'Rejected','8'=>'Certification In-Process','9'=>'Certification Generated');
	...
	public function getWithdrawunit()
    {
        return $this->hasMany(WithdrawUnit::className(), ['withdraw_id' => 'id']);
    }

    public function getFranchisecmt()
    {
        return $this->hasMany(WithdrawFranchiseComment::className(), ['withdraw_id' => 'id']);
    }

    public function getReviewercmt()
    {
        return $this->hasMany(WithdrawReviewerComment::className(), ['withdraw_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(WithdrawProduct::className(), ['withdraw_id' => 'id']);
    }
    ...
    {
        return $this->hasOne(WithdrawReviewer::className(), ['withdraw_id' => 'id'])->andOnCondition(['reviewer_status' => 1]);
    }
