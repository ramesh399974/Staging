...
/**
 * This is the model class for table "tbl_user_business_group".
 *
 * @property int $id
 ...
 */
class UserBusinessGroup extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_user_business_group';
    }
    ...
    public function getGroupcodeactive()
    {
        return $this->hasMany(UserBusinessGroupCode::className(), ['business_group_id' => 'id'])->andOnCondition(['status' => 2]);
    }
