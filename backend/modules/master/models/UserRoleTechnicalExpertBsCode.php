...
/**
 * This is the model class for table "tbl_user_role_technical_expert_business_group_code".
 *
 * @property int $id
 * @property int $status
 ...
 */
class UserRoleTechnicalExpertBsCode extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'tbl_user_role_technical_expert_business_group_code';
    }
