...
class Offer extends \yii\db\ActiveRecord
{
	...
	public function generateInvoice($offermodel,$type)
	{
		...
		{	
			...
			$invoicemodel->currency_code=$offerlist->currency;
			$invoicemodel->conversion_currency_code =  $offerlist->conversion_currency_code;
			$invoicemodel->conversion_currency =  $offerlist->conversion_currency_code;
			$invoicemodel->conversion_rate = $offerlist->conversion_rate;
			$invoicemodel->conversion_total_fee = $offerlist->conversion_total;
			$invoicemodel->conversion_tax_amount = $offerlist->conversion_tax_amount;
			$invoicemodel->conversion_total_payable_amount = $offerlist->conversion_total_payable;
			$invoicemodel->conversion_required_status= $offerlist->conversion_required_status;
			//$offerlist->conversion_currency_code ? $offerlist->conversion_currency_code : $offerlist->currency;		
			//New Code oct 30,2020 ends
			...
			conversion_total_fee
			conversion_tax_amount
			conversion_total_payable_amount
			*/
