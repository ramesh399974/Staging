...
class RawMaterialProduct extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'certified_weight' => 'Certified Weight (kg)',
            'actual_net_weight' => 'Net Weight (kg)',
            'balance_weight' => 'Balance Weight (kg)',
    ...
    public function getTcusedweight()
    {
        return $this->hasMany(TcRawMaterialUsedWeight::className(), ['tc_raw_material_product_id' => 'id']);
    }

    public function getAnytcusedweight()
    {
        return $this->hasOne(TcRawMaterialUsedWeight::className(), ['tc_raw_material_product_id' => 'id'])->andOnCondition(['status' => 0]);
    }
