	...
	*/
					...
					*/
					...
					if($editStatus==0)
					{
						...
						foreach($standard_ids as $standardid) {
							...
							$tcdeclarationmodel = TcRequestDeclaration::find()->where(['standard_id'=>$standardid])->one();
                            $TcDeclarationContent = $tcdeclarationmodel->declaration;
						}
						
						
						// if(count($data['standard_id']) >= 2){
						// 	$model->declaration='This is to certify that, based on the relevant documentation provided by the seller named in box 3, (i) the material used for the products as further detailed / referred to in box 10 and quantified in box 11, 12 and 13 has been produced in accordance with Textile Exchange Standards (GRS and OCS) referred to in Box 13. Conformity with the standard is audited and monitored systematically under responsibility of the certification body named in box 1';
							
						// 	$model->additional_declaration='Certification of the organic material used for the products listed complies with USDA NOP rules - <b>'.$usda_nop.'</b> and APEDA NPOP rules - <b>'.$usda_nop.'</b> (relevant information for products marketed and sold in the US; obligatory information for any '.$tc_std_code.' TC)';
						// }else {
							// $model->declaration='This is to certify that, based on the relevant documentation provided by the seller named in Box 2 “Seller of Certified Products”: <br><br>  
							...
							// and Declared Geographic Origin” and quantified in Box 4 “Gross Shipping Weight”, Box 5 “Net Shipping Weight” and Box 6 
							// “Certified Weight” has / have been produced in accordance with (an) organic farming standard(s) which is/are recognized by GOTS, 
							// and <br><br>ii. the products in Box 10 “Certified Products” have been processed in accordance with GOTS. Conformity with the standard is audited 
							// and monitored systematically under responsibility of the certification body named in Box 1.';
							
						// 	$model->additional_declaration='<b>Certification of the organic material used for the products listed complies with USDA NOP rules -'.$usda_nop.'</b> <br> (relevant information for products marketed and sold in the US; obligatory information for any '.$tc_std_code.' TC)';
						// }
						...
						$model->additional_declaration='<b>Certification of the organic material used for the products listed complies with USDA NOP rules : '.$usda_nop.'</b> <br>
                        (relevant information for products marketed and sold in the US; obligatory information for any '.$tc_std_code.' TC)';
	...
	public function generateTC($requestID,$returnType=false)
	{
		...
		if($model !== null)
		{
			...
			{
				$Sub_contractor_declaration = "Yes";
			} else if($is_subcontractor_declared == null)
			{
				$Sub_contractor_declaration = "No";
			}
			...
			*/			
			...
			<htmlpageheader name="firstpage" style="display:none;">
				<div style="width:100%;font-size:12px;font-family:Arial;position: absolute;margin-bottom: 75px;">
					<table cellpadding="0" cellspacing="0" border="0" width="100%"  style="border:none;">
						<tr>					    
							<td class="reportDetailLayoutInner" style="width:80%;padding-top:15px;font-size:16px;font-weight:bold;text-align: center;border:none;">'.$draftText.' TRANSACTION CERTIFICATE (TC) <br> Transaction Certificate Number ['.implode(", ",$RegistrationNoArray).'] <br> for products certified to <br>  '.$tc_std_name.' ('.$tc_std_code.') </td>
			...
			$TcProductContent='<div  style="width:100%;"  style="margin-top:0px;">';		
			
			$TcShipmentContent='';	
			
			$TcShipmentContent = '
			<div   style="width:100%;"  style="margin-top:0px;">';
					...
					foreach($requestProducts as $requestProduct)
					{
						...
						{	
							...
							if($tcN!='')
							{
								...
								$Country =($RawMaterialObj->country_id!="")?$RawMaterialObj->country->name:"N/A";
								$State =($RawMaterialObj->state_id!="")?$RawMaterialObj->state->name:"N/A";
								$RawMaterialName =($RawMaterialObj->rawmaterial_name_id!="")?$RawMaterialObj->rawmaterialname->name:"N/A";
						...
						<div style="width:100%;">
						 <div style="width:50%;float: left;">Product No :</div><div style="width:50%;float: left;">'.$prtCnt.'</div>
						 <div style="width:50%;float: left;">Order Number :</div><div style="width:50%;float: left;">'.$requestProduct->purchase_order_no.'</div>
						 <div style="width:50%;float: left;">Article No :</div><div style="width:50%;float: left;">'.$requestProduct->lot_ref_number.'</div>
						 <div style="width:50%;float: left;">Number of Units :</div><div style="width:50%;float: left;">'.$packedInUnitInfo.'</div>
						 <div style="width:50%;float: left;">Net Shipping Weight :</div><div style="width:50%;float: left;">'.number_format($requestProduct->net_weight,1).' kg</div>
						 <div style="width:50%;float: left;">Supplementary Weight :</div><div style="width:50%;float: left;">'.number_format($requestProduct->supplementary_weight,1).' kg</div>
						 <div style="width:50%;float: left;">Certified Weight :</div><div style="width:50%;float: left;">'.number_format($requestProduct->certified_weight,1).' kg</div>
						</div> 
						</div> 
						
						<div style="width:40%;float: left;">
						<div style="width:100%;">
						 <div style="width:50%;float: left;">Product Category :</div><div style="width:50%;float: left;">'.$productname.'</div>
						 <div style="width:50%;float: left;">Product Detail :</div><div style="width:50%;float: left;">'.$producttypename.'</div>
						 <div style="width:50%;float: left;">Material Composition : </div><div style="width:50%;float: left;">'.$materialcompositionname.'</div>
						 <div style="width:50%;float: left;">Label Grade :</div><div style="width:50%;float: left;">'.$labelgradename.'</div>
						 <div style="width:50%;float: left;">Additional Info :</div><div style="width:50%;float: left;">'.$requestProduct->trade_name.'</div>
						 <div style="width:50%;float: left;">Last Processor :</div><div style="width:50%;float: left;">'.$applicationCompanyUnitName.'</div>
						 <div style="width:50%;float: left;">- License No.: </div><div style="width:50%;float: left;">'.$customeroffernumber.'</div>
						 <div style="width:50%;float: left;">- Country: </div><div style="width:50%;float: left;">'.$LastProcessorCountry.'</div>
						</div>
						</div>
						</div>
						';
						...
						<div style="width:40%;float: left;">
						<div style="width:100%;">
						<div style="width:50%;float: left;">Shipment No :</div><div style="width:50%;float: left;">'.$prtCnt.'</div>
						<div style="width:50%;float: left;">Shipment Date :</div><div style="width:50%;float: left;">'.date('Y-m-d',strtotime($requestProduct->invoice_date)).'</div>
						<div style="width:50%;float: left;">Shipment Doc No :</div><div style="width:50%;float: left;">'.$requestProduct->transport_document_no.' kg</div>
						<div style="width:50%;float: left;">Gross Shipping Weight :</div><div style="width:50%;float: left;">'.number_format($requestProduct->gross_weight,1).' kg</div>
						<div style="width:50%;float: left;">Invoice References :</div><div style="width:50%;float: left;">'.$requestProduct->invoice_no.'</div>
						</div> 
						</div> 
						
						<div style="width:60%;float: left;">
						<span>Consignee Name and Address:</span><br>
						<span>'.$consigneeName.'</span>
						<span>'.$consigneeAddress1.'</span><br>
						<span>'.$consigneeAddress2.'</span><br>
						</div>
						</div>
						';
						...
						<hr>
						 ...
						 <div style="width:40%;">'.$prtCnt.'.'.$RawMaterialName.'  </div>
						 <div style="width:60%;float: left;">Certified Weight :'.number_format($CertifiedWeight,2).' kg</div>
	       ...
	       if(count($model->standard)>0 && count($model->standard)>1){
			...
			// $SignatureContent='{SNO} Signature of Authorised Person<br>';
			...
			$TcLogoContentFirstPage = str_replace('{SNO}','<span class="innerTitleMain"></span>',$TcLogoContentFirstPage);
			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%" class="reportDetailLayoutInner" style="margin-top:10px;">
				<tr>
					...
					<td class="reportDetailLayoutInner" width="51%">
						...
						<span class="innerTitle">SC Number:  '.implode(", ",$RegistrationNoArray).'</span><br>
				...
				<tr>
					...
					<td class="reportDetailLayoutInner" style=" padding-bottom: 15px;">
				...
				$html.= '<tr>
				<td class="reportDetailLayoutInner"   style=" padding-bottom: 15px;" colspan="2">
				<span class="innerTitleMain">8. Certified Input References</span><br><br>
				<span class="innerTitle">Input TCs:</span> 
				'.($raw_material_tc_no ? $raw_material_tc_no : '-').' <br><hr>
				<span class="innerTitle">Farm SCs : </span> 
				'.($raw_material_farm_sc_no ? $raw_material_farm_sc_no : '-').' <br><hr>
				<span class="innerTitle">Farm TCs: </span> 
				'.($raw_material_farm_tc_no ? $raw_material_farm_tc_no : '-').' <br><hr>
				<span class="innerTitle">Trader TCs for Organic Material: </span> 
				...
				$html.= '<tr style="border: 0px solid black;">
					<td class="" colspan="2" style="padding-top: 10px;">
				...
				$html.= '<tr style="border: 0px solid black;">
					<td class="" colspan="2" style="padding-top:  50px;">
			...
			// <table cellpadding="0" cellspacing="0" border="0" width="100%" class="reportDetailLayoutInner" style="margin-top:10px;">									
			//  	<tr>
			// 		 <td class="reportDetailLayoutInner" style="width:80%;padding-top:15px;font-size:14px;font-weight:bold;text-align: center;border:none;">Transaction Certificate Number ['.implode(", ",$RegistrationNoArray).']  (continued) </td>
			//  	</tr>
			// </table>';

			 $html.= '<pagebreak />										
			 <div style="padding-top:10px;font-size:14px;font-weight:bold;text-align: center;border:none;"> Transaction Certificate Number ['.implode(", ",$RegistrationNoArray).']  (continued)</div>';
			...
			$TcLogoContentInnerPage = str_replace('{DATEANDPLACE}',$DatePlaceContent,$TcLogoContentFirstPage);
			...
			<span class="innerTitle">The certified product(s) covered in this certificate have been outsourced to a subcontractor:</span> 
				<b>'.($Sub_contractor_declaration).'</b> <br><br>
	...
	public function actionDownload()
	{
				...
				$filename ='Individually Certified Subcontractor.docx';				
				header('Access-Control-Allow-Origin: *');
				header('Access-Control-Allow-Methods: GET, PUT, POST, DELETE, OPTIONS');
				header('Access-Control-Max-Age: 1000');
				header('Access-Control-Allow-Headers: Content-Type, Authorization, X-Requested-With');
