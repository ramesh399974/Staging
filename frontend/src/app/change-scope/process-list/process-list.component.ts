...
import { ProcessAdditionListService } from '@app/services/change-scope/process-addition-list.service';
...
@Component({
  ...
  providers: [ProcessAdditionListService, DecimalPipe]
})
export class ProcessListComponent{

  processadditions$: Observable<Processaddition[]>;
  ...
  constructor(public service: ProcessAdditionListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) 
  {
    this.processadditions$ = service.processadditions$;
