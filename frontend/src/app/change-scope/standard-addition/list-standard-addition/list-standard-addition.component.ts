...
import { StandardAdditionListService } from '@app/services/change-scope/standard-addition-list.service';
...
@Component({
  selector: 'app-list-standard-addition',
  templateUrl: './list-standard-addition.component.html',
  styleUrls: ['./list-standard-addition.component.scss'],
  providers: [StandardAdditionListService, DecimalPipe]
})
export class ListStandardAdditionComponent {

  standardadditions$: Observable<Standardaddition[]>;
  ...
  constructor(public service: StandardAdditionListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) 
  {
    this.standardadditions$ = service.standardadditions$;
