...
import {WithdrawUnitListService} from '@app/services/change-scope/withdraw-unit-list.service';
...
@Component({
  selector: 'app-list-withdraw-unit',
  templateUrl: './list-withdraw-unit.component.html',
  styleUrls: ['./list-withdraw-unit.component.scss'],
  providers: [WithdrawUnitListService, DecimalPipe]
})
export class ListWithdrawUnitComponent{

  withdrawunits$: Observable<Withdrawunit[]>;
  ...
  constructor(public service: WithdrawUnitListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) 
  {
    this.withdrawunits$ = service.withdrawunits$;
