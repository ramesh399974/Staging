...
import {StandardListService} from '@app/services/master/standard/standard-list.service';
...
@Component({
  selector: 'app-list-audit-standard',
  templateUrl: './list-audit-standard.component.html',
  styleUrls: ['./list-audit-standard.component.scss']
})
export class ListAuditStandardComponent  {
  ...
  constructor(public service: AuditStandardService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
