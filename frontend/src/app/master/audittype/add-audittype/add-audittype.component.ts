...
@Component({
  selector: 'app-add-audittype',
  templateUrl: './add-audittype.component.html',
  styleUrls: ['./add-audittype.component.scss']
})
export class AddAudittypeComponent implements OnInit {
  ...
  constructor(private router: Router,private fb:FormBuilder,private audittypeService:AudittypeService,private errorSummary: ErrorSummaryService) { }
  ...
  onSubmit(){
    ...
    if (this.form.valid) {
      ...
      this.audittypeService.addData(this.form.value)
      .pipe(
        first()        
      )
      .subscribe(res => {
