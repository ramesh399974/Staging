...
import {AudittypeListService} from '@app/services/master/audittype/audittype-list.service';
...
@Component({
  selector: 'app-list-audittype',
  templateUrl: './list-audittype.component.html',
  styleUrls: ['./list-audittype.component.scss'],
  providers: [AudittypeListService, DecimalPipe]
})
export class ListAudittypeComponent {
  ...
  constructor(public service: AudittypeListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService){
    this.audittypes$ = service.audittypes$;
