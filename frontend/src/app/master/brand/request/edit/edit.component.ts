...
export class EditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.countryservice.getCountry().subscribe(res => {
      ...
      this.service.getBrandGroup().subscribe(res => {
        if (res.status) {
      ...
      */	  
      ...
      this.userService.getBrandUserDetails(this.id).pipe(first(),
      tap(res=>{
      ...
      onSubmit(){
        ...
        if (this.form.valid) {
            ...
            this.userService.updateBrandUserData(formvalue).pipe(first()
          ).subscribe(res => {
