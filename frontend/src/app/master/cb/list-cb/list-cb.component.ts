...
import {CbListService} from '@app/services/master/cb/cb-list.service';
...
@Component({
  selector: 'app-list-cb',
  templateUrl: './list-cb.component.html',
  styleUrls: ['./list-cb.component.scss'],
  providers: [CbListService, DecimalPipe]
})
export class ListCbComponent {
  ...
  constructor(public service: CbListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.Cb$ = service.bsectors$;
