...
@Component({
  selector: 'app-add-clientlogo-checklist-customer',
  templateUrl: './add-clientlogo-checklist-customer.component.html',
  styleUrls: ['./add-clientlogo-checklist-customer.component.scss']
})
export class AddClientlogoChecklistCustomerComponent implements OnInit {
  ...
  category:any;
  constructor(private router: Router,private fb:FormBuilder, private processService:ProcessService, private clientlogoService: CustomerClientlogoChecklistService,private errorSummary: ErrorSummaryService,public standardservice:StandardService) { }
