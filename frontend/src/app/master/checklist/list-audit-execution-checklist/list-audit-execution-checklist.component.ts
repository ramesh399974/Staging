...
import { AuditExecutionChecklistListService } from '@app/services/master/checklist/audit-execution-checklist-list.service';
...
@Component({
  selector: 'app-list-audit-execution-checklist',
  templateUrl: './list-audit-execution-checklist.component.html',
  styleUrls: ['./list-audit-execution-checklist.component.scss'],
  providers: [AuditExecutionChecklistListService]
})
export class ListAuditExecutionChecklistComponent implements OnInit {

  auditExecutionchecklist$: Observable<AuditExecutionChecklist[]>;
  ...
  constructor(public service: AuditExecutionChecklistListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService,private standardservice: StandardService, private SubTopicService: SubTopicService){
    this.auditExecutionchecklist$ = service.auditExecutionChecklists$;
    //console.log(service.auditExecutionChecklists$);
