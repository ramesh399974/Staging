...
import {AuditPlanningChecklistListService} from '@app/services/master/checklist/audit-planning-checklist-list.service';
...
@Component({
  selector: 'app-list-audit-planning-checklist',
  templateUrl: './list-audit-planning-checklist.component.html',
  styleUrls: ['./list-audit-planning-checklist.component.scss'],
  providers: [AuditPlanningChecklistListService]
})
export class ListAuditPlanningChecklistComponent {

  title='';
  auditplanningchecklists$: Observable<AuditPlanningChecklist[]>;
  ...
  constructor(private activatedRoute:ActivatedRoute,private router: Router,public service: AuditPlanningChecklistListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.auditplanningchecklists$ = service.auditplanningchecklists$;
    ...
    if(this.category == 2){
      this.title = 'Audit Planning Unit Review Checklist';
      conditionname = 'app_planning_review_unit_checklist';
    }else{
      this.title = 'Audit Planning Review Checklist';
      conditionname = 'app_planning_review_checklist';
    }
