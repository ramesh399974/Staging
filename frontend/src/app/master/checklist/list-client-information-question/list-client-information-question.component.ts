...
import {ClientInformationChecklistListService} from '@app/services/master/checklist/client-information-checklist-list.service';
...
@Component({
  selector: 'app-list-client-information-question',
  templateUrl: './list-client-information-question.component.html',
  styleUrls: ['./list-client-information-question.component.scss'],
  providers: [ClientInformationChecklistListService]
})
export class ListClientInformationQuestionComponent {

  title='Client Information Question Checklist';
  informationchecklists$: Observable<ClientInformationChecklist[]>;
  ...
  constructor(public service: ClientInformationChecklistListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService,private standardservice: StandardService) {
    ...
    this.authservice.currentUser.subscribe(x => {
      if(x){
        ...
        {
          if(this.userdetails.rules.includes('edit_client_information_question_checklist')  ){
            this.canEditData = true;
          }
          if(this.userdetails.rules.includes('delete_client_information_question_checklist') ){
            this.canDeleteData = true;
          }
          if(this.userdetails.rules.includes('add_client_information_question_checklist')  ){
            this.canAddData = true;
          }
          if(this.userdetails.rules.includes('activate_client_information_question_checklist')  ){
            this.canActivateData = true;
          }
          if(this.userdetails.rules.includes('deactivate_client_information_question_checklist')  ){
