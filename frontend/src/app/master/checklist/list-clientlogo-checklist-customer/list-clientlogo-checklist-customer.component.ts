...
import {CustomerClientlogoChecklistListService} from '@app/services/master/checklist/customer-clientlogo-checklist-list.service';
...
@Component({
  selector: 'app-list-clientlogo-checklist-customer',
  templateUrl: './list-clientlogo-checklist-customer.component.html',
  styleUrls: ['./list-clientlogo-checklist-customer.component.scss'],
  providers: [CustomerClientlogoChecklistListService]
})
export class ListClientlogoChecklistCustomerComponent {

  title='Customer Client Logo Checklist';
  informationchecklists$: Observable<CustomerClientlogoChecklist[]>;
  ...
  constructor(public service: CustomerClientlogoChecklistListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService,private standardservice: StandardService) {
