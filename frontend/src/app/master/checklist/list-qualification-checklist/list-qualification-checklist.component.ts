...
import {QualificationChecklistListService} from '@app/services/master/checklist/qualification-checklist-list.service';
...
@Component({
  selector: 'app-list-qualification-checklist',
  templateUrl: './list-qualification-checklist.component.html',
  styleUrls: ['./list-qualification-checklist.component.scss'],
  providers: [QualificationChecklistListService]
})
export class ListQualificationChecklistComponent {

  qualificationchecklists$: Observable<QualificationChecklist[]>;
  ...
  constructor(public service: QualificationChecklistListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.qualificationchecklists$ = service.qualificationchecklists$;
