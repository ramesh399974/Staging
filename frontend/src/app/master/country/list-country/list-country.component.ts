...
import {CountryListService} from '@app/services/master/country/country-list.service';
...
@Component({
  ...
  providers: [CountryListService, DecimalPipe]
})
export class ListCountryComponent  {
  ...
  constructor(public service: CountryListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
