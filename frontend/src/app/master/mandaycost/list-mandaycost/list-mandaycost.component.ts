...
import {MandaycostListService} from '@app/services/master/mandaycost/mandaycost-list.service';
...
@Component({
  selector: 'app-list-mandaycost',
  templateUrl: './list-mandaycost.component.html',
  styleUrls: ['./list-mandaycost.component.scss'],
  providers: [MandaycostListService]
})
export class ListMandaycostComponent {

  mandaycosts$: Observable<Mandaycost[]>;
  ...
  constructor(public service: MandaycostListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.mandaycosts$ = service.mandaycosts$;
