...
import {MaterialCompositionListService} from '@app/services/master/materialcomposition/materialcomposition-list.service';
...
@Component({
  ...
  templateUrl: './list-materialcomposition.component.html',
  styleUrls: ['./list-materialcomposition.component.scss'],
  providers:[MaterialCompositionListService]
})
export class ListMaterialcompositionComponent{

  materialcompositions$: Observable<MaterialComposition[]>;
