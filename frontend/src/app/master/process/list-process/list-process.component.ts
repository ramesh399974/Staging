...
import {ProcessListService} from '@app/services/master/process/process-list.service';
...
@Component({	
  ...
  providers: [ProcessListService, DecimalPipe]
})
export class ListProcessComponent {
  ...
  constructor(public service: ProcessListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.processes$ = service.processes$;
