...
import {ProductTypeListService} from '@app/services/master/producttype/producttype-list.service';
...
@Component({
  selector: 'app-list-producttype',
  templateUrl: './list-producttype.component.html',
  styleUrls: ['./list-producttype.component.scss'],
  providers:[ProductTypeListService]
})
export class ListProducttypeComponent{
  ...
  constructor(public service: ProductTypeListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.producttypes$ = service.producttypes$;
