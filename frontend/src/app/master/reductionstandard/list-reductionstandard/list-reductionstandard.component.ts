...
import {ReductionStandardListService} from '@app/services/master/reductionstandard/reductionstandard-list.service';
...
@Component({
  selector: 'app-list-reductionstandard',
  templateUrl: './list-reductionstandard.component.html',
  styleUrls: ['./list-reductionstandard.component.scss'],
  providers: [ReductionStandardListService, DecimalPipe]
})
export class ListReductionstandardComponent{
  ...
  constructor(public service: ReductionStandardListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) 
  {
