...
import { StandardreductionmaximumService } from '@app/services/master/reductionstandard/standardreductionmaximum.service';
...
@Component({
  selector: 'app-standard-reduction-maximum',
  templateUrl: './standard-reduction-maximum.component.html',
  styleUrls: ['./standard-reduction-maximum.component.scss'],
  providers: [StandardreductionmaximumService]
})
export class StandardReductionMaximumComponent implements OnInit {

  title = '';
  Standardreductionmaximum$: Observable<Standardreductionmaximum[]>;
  ...
  model: any = {id:null,action:null,type:'',standard:'',standards:'',date:''};
  success:any;
  modalss:any;
  ...
  constructor(private modalService: NgbModal,private activatedRoute:ActivatedRoute,private router: Router,private fb:FormBuilder, public userService:UserService,public service: StandardreductionmaximumService,public errorSummary: ErrorSummaryService, private authservice:AuthenticationService,private standardservice: StandardService,private standardreductionService:StandardreductionService) { 
  
    this.Standardreductionmaximum$ = service.standardreductionmaximum$;
	...
	*/
	...
	//console.log(this.Standardreductionmaximum.length);
  ...
  ngOnInit() {
	...
	this.title = 'Standard Reduction Maximum';	
  ...
  getSelectedStandardValue(val)
  {
    ...
    return this.reductionStandardList.find(x=> x.id==val).code;
  ...
  addData()
  {
    ...
    if(this.form.valid)
    {
      ...
      expobject = {reduction_percentage:reduction_percentage,standards:standards,standard_id:standard_id};
