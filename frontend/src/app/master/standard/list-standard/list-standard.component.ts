...
@Component({
  ...
  providers: [StandardListService, DecimalPipe]
})
export class ListStandardComponent  {
  ...
  constructor(public service: StandardListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
