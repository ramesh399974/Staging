...
import { StandardCombinationApplicationListService } from '@app/services/master/standard-combination-application/standard-combination-application-list.service';
...
@Component({
  selector: 'app-standardcombinationapplication',
  templateUrl: './standardcombinationapplication.component.html',
  styleUrls: ['./standardcombinationapplication.component.scss'],
 providers: [ StandardCombinationApplicationListService]
})

export class StandardcombinationapplicationComponent implements OnInit 
{
  title = '';
  StandardCombination$: Observable<StandardCombinationApplication[]>;
  ...
  constructor(private modalService: NgbModal,private activatedRoute:ActivatedRoute,
    private router: Router,private fb:FormBuilder, public userService:UserService,
    public service: StandardCombinationApplicationListService,public errorSummary: ErrorSummaryService, 
    private authservice:AuthenticationService,public standardservice:StandardService,public standardListService:StandardListService)
     { 
  ...
  ngOnInit() 
  {
    this.title = 'Application Standard Combination';
