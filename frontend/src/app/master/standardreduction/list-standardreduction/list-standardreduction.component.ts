...
import {StandardreductionListService} from '@app/services/master/standardreduction/standardreduction-list.service';
...
@Component({
  selector: 'app-list-standardreduction',
  templateUrl: './list-standardreduction.component.html',
  styleUrls: ['./list-standardreduction.component.scss'],
  providers:[StandardreductionListService]
})
export class ListStandardreductionComponent {

   standardreductions$: Observable<Standardreduction[]>;
  ...
  constructor(public service: StandardreductionListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.standardreductions$ = service.standardreductions$;
