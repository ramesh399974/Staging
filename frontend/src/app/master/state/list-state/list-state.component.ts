...
import {StatesListService} from '@app/services/master/states/states-list.service';
...
@Component({
  ...
  providers: [StatesListService, DecimalPipe]
})
export class ListStateComponent {

  stats$: Observable<States[]>;
  ...
  constructor(public service: StatesListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
