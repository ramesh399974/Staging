...
import {SubTopicListService} from '@app/services/master/sub-topic/sub-topic-list.service';
...
@Component({
  selector: 'app-list-sub-topic',
  templateUrl: './list-sub-topic.component.html',
  styleUrls: ['./list-sub-topic.component.scss'],
  providers: [SubTopicListService, DecimalPipe]
})
export class ListSubTopicComponent {

  SubTopic$: Observable<SubTopic[]>;
  ...
  constructor(public service: SubTopicListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
    this.SubTopic$ = service.bsectors$;
