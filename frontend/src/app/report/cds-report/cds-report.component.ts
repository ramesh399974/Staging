...
import { CdsReportService } from '@app/services/report/cds-report.service';
...
@Component({
  selector: 'app-cds-report',
  templateUrl: './cds-report.component.html',
  styleUrls: ['./cds-report.component.scss']
})
export class CdsReportComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private userservice: UserService,private router: Router,private fb:FormBuilder,private standardservice: StandardService, private authservice:AuthenticationService,private errorSummary: ErrorSummaryService,public service: CdsReportService) { }
