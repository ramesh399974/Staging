...
import { ProgramAuditReportService } from '@app/services/report/program-audit-report.service';
...
@Component({
  selector: 'app-program-audit-report',
  templateUrl: './program-audit-report.component.html',
  styleUrls: ['./program-audit-report.component.scss']
})
export class ProgramAuditReportComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private userservice: UserService,private router: Router,private fb:FormBuilder,private standardservice: StandardService, private authservice:AuthenticationService,private errorSummary: ErrorSummaryService,public service: ProgramAuditReportService) { }
