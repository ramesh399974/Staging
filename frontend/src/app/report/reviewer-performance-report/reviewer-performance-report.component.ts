...
import { ReviewerPerformanceReportService } from '@app/services/report/reviewer-performance-report.service';
...
@Component({
  selector: 'app-reviewer-performance-report',
  templateUrl: './reviewer-performance-report.component.html',
  styleUrls: ['./reviewer-performance-report.component.scss']
})
export class ReviewerPerformanceReportComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private userservice: UserService,private router: Router,private fb:FormBuilder,private standardservice: StandardService, private authservice:AuthenticationService,private errorSummary: ErrorSummaryService,public service: ReviewerPerformanceReportService) { }
