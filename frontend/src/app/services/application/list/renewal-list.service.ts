...
export class RenewalListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/application/renewal-request/index`,{page,pageSize,searchTerm,statusFilter,sortColumn,sortDirection,standardFilter, typeFilter}).pipe(
        map(result => {
  ...
  getRequest(data):Observable<any>{
    ...
    return this.http.post<any>(`${environment.apiUrl}/application/renewal-request/view`,data);
