...
export class AuditReportAttendanceSheetService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/audit/audit-attendance/index`,{audit_id:this.audit_id,unit_id:this.unit_id,page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
