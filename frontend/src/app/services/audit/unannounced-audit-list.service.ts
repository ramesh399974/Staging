...
export class UnannouncedAuditListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/unannouncedaudit/unannounced-audit/index`,{page,pageSize,searchTerm,sortColumn,sortDirection,standardFilter}).pipe(
        map(result => {
