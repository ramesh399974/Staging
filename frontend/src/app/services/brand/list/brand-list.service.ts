...
export class ApplicationListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/application/brands/index`,{page,pageSize,searchTerm,statusFilter,sortColumn,sortDirection,standardFilter, typeFilter, franchiseFilter}).pipe(
        map(result => {
