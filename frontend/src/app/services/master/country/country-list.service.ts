...
export class CountryListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/country/index`,{page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
          return {countries:result.countries,total:result.total};
        })
    );
  ...
  addCountry(countryData){
    ...
    //let countryDatas = Object.assign({}, countryData);
    return this.http.post<any>(`${environment.apiUrl}/master/country/create`, countryData);
    //, JSON.stringify(data)
  }

  getCountry():Observable<any>{
    
    return this.http.get<any>(`${environment.apiUrl}/master/country/index`,this.httpOptions);
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/country/common-update`,data);
  } 
}
