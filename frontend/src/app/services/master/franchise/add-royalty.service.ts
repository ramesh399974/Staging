...
export class AddRoyaltyListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    console.log('3');
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/franchise/get-royalty`,{franchise_id:franchise_id,type:this.type,page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addData(data){
    return this.http.post<any>(`${environment.apiUrl}/master/franchise/add-royalty`, data);
  }
 
  deleteData(data){
    return this.http.post<any>(`${environment.apiUrl}/master/franchise/delete-royalty`, data);
  }
