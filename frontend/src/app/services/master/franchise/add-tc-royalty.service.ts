...
export class AddTcRoyaltyListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/franchise/get-tc-royalty`,{franchise_id:franchise_id,type:this.type,page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addData(data){
    return this.http.post<any>(`${environment.apiUrl}/master/franchise/add-tc-royalty`, data);
  }
 
  deleteData(data){
    return this.http.post<any>(`${environment.apiUrl}/master/franchise/delete-tc-royalty`, data);
  }
