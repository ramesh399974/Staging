...
export class ProductListService {
  ...
  addProduct(productData){
    ...
    return this.http.post<any>(`${environment.apiUrl}/master/product/create`, productData);
    //, JSON.stringify(data)
  }

  getProduct():Observable<any>{
    
    return this.http.get<any>(`${environment.apiUrl}/master/product/index`,this.httpOptions);
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/product/common-update`,data);
  }
}
