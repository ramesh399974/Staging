...
export class ProductService {
  ...
  getMaterialname(type,standard_ids): Observable<MaterialComposition[]>{
    return this.http.post<MaterialComposition[]>(`${environment.apiUrl}/transfercertificate/material/searchlistmaterialname`,{type,standard_ids});
  }
