...
export class ReductionStandardListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/reduction-standard/index`,{page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addStandard(standardData){
    ...
    return this.http.post<any>(`${environment.apiUrl}/master/reduction-standard/create`, standardData);
    //, JSON.stringify(data)
  }

  getStandard():Observable<any>{
    
    return this.http.get<any>(`${environment.apiUrl}/master/reduction-standard/index`,this.httpOptions);
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/reduction-standard/common-update`,data);
  } 
}
