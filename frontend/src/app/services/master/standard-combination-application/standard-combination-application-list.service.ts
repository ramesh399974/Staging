...
import { StandardCombinationApplication } from '@app/models/master/standard-combination-application';

interface SearchResult {
  standardCombination: StandardCombinationApplication[];
  total: number; 
}
interface State {
  page: number;
...
function sort(standardCombination: StandardCombinationApplication[], column: string, direction: string): StandardCombinationApplication[] {
  if (direction === '') {
...
function matches(standardCombination: StandardCombinationApplication, term: string, pipe: PipeTransform) {
...
export class StandardCombinationApplicationListService {
  private _loading$ = new BehaviorSubject<boolean>(true);
  private _search$ = new Subject<void>();
  private _standardCombination$ = new BehaviorSubject<StandardCombinationApplication[]>([]);
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/application-standard-combination/index`,{type:this.type,page,pageSize,statusFilter,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addData(data){
    return this.http.post<any>(`${environment.apiUrl}/master/application-standard-combination/create`, data);
  }
 
  deleteData(data){
    return this.http.post<any>(`${environment.apiUrl}/master/application-standard-combination/deletedata`, data);
  }
  
  downloadFile(data){
    return this.http.post(`${environment.apiUrl}/master/application-standard-combination/downloadfile`,data,
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/application-standard-combination/common-update`,data);
  } 
  // ------ New Code End Here ---------
