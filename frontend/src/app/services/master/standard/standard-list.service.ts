...
export class StandardListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/standard/index`,{page,pageSize,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/standard/common-update`,data);
  } 
}
