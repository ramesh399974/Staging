...
export class CustomerListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    const {sortColumn, sortDirection, pageSize, page, searchTerm, countryFilter, statusFilter} = this._state;
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/master/user/index`,{type:2,page,pageSize,searchTerm,sortColumn,sortDirection, countryFilter, statusFilter}).pipe(
        map(result => {
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/master/customer/common-update`,data);
  } 
}
