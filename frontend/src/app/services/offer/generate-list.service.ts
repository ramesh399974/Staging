...
export class GenerateListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    const {sortColumn, sortDirection, statusFilter, pageSize, page, searchTerm,standardFilter,franchiseFilter} = this._state;
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/offer/generate-offer/index`,{page,pageSize,searchTerm,statusFilter,sortColumn,sortDirection,standardFilter,franchiseFilter}).pipe(
        map(result => {
  ...
  getData(){
    return this.http.post<any>(`${environment.apiUrl}/offer/generate-offer/get-data`, {});
  }
