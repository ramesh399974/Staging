...
export class CdsReportService {
  ...
  getData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/report/cds-report/index`,data);
  }

  downloadFile(data){
    return this.http.post(`${environment.apiUrl}/report/cds-report/index`,data,
