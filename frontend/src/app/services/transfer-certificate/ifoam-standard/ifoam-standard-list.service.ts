...
export class IfoamStandardListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/transfercertificate/tc-ifoam-standard/index`,{type:this.type,page,pageSize,statusFilter,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addData(data){
    return this.http.post<any>(`${environment.apiUrl}/transfercertificate/tc-ifoam-standard/create`, data);
  }
 
  deleteData(data){
    return this.http.post<any>(`${environment.apiUrl}/transfercertificate/tc-ifoam-standard/deletedata`, data);
  }
  
  
  getStandardList(): Observable<Standard[]>{
    return this.http.get<Standard[]>(`${environment.apiUrl}/transfercertificate/tc-ifoam-standard/get-standard`);
  } 
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/transfercertificate/tc-ifoam-standard/common-update`,data);
  } 
  // ------ New Code End Here ---------
