...
export class StandardCombinationListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    */
    ...
    return this.http.post<SearchResult>(`${environment.apiUrl}/transfercertificate/tc-standard-combination/index`,{type:this.type,page,pageSize,statusFilter,searchTerm,sortColumn,sortDirection}).pipe(
        map(result => {
  ...
  addData(data){
    return this.http.post<any>(`${environment.apiUrl}/transfercertificate/tc-standard-combination/create`, data);
  }
 
  deleteData(data){
    return this.http.post<any>(`${environment.apiUrl}/transfercertificate/tc-standard-combination/deletedata`, data);
  }
  
  downloadFile(data){
    return this.http.post(`${environment.apiUrl}/transfercertificate/tc-standard-combination/downloadfile`,data,
  ...
  commonActionData(data): Observable<any>{
    return this.http.post<any>(`${environment.apiUrl}/transfercertificate/tc-standard-combination/common-update`,data);
  } 
  // ------ New Code End Here ---------
