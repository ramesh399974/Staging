...
export class CompanyListService {
  ...
  private _search(): Observable<SearchResult> {
    ...
    const {sortColumn, sortDirection, statusFilter, pageSize, page, searchTerm, standardFilter, riskFilter, typeFilter} = this._state;
    
    return this.http.post<SearchResult>(`${environment.apiUrl}/unannouncedaudit/unannounced-audit/company-list`,{page,pageSize,searchTerm,statusFilter,sortColumn,sortDirection,standardFilter, riskFilter, typeFilter}).pipe(
      map(result => {
