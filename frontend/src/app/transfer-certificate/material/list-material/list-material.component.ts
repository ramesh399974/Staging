...
import { MaterialListService } from '@app/services/transfer-certificate/material/material-list.service';
...
export class ListMaterialComponent {
  ...
  constructor(private standards: StandardService,public service: MaterialListService,private modalService: NgbModal,private errorSummary: ErrorSummaryService, private authservice:AuthenticationService) {
